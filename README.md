...
A KiCad 7/8 redesign of the open-source **Candlelight** USB-CAN adapter, rebuilt as a clean hierarchical multi-sheet schematic with a production-ready 2-layer PCB layout.
